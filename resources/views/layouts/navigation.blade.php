<nav x-data="{ open: false }"
    class="relative z-30 bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="/home" class="flex items-center">
                        ...
                        <svg class="w-16 h-16 mr-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        <x-nav-link :href="route('user.assessments.index')"
                            :active="request()->routeIs('user.assessments.*')">
                            {{ __('My Assessments') }}
                        </x-nav-link>
            ...
            <div class="flex items-center -me-2 sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 text-gray-400 transition duration-150 ease-in-out rounded-md hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                <x-responsive-nav-link :href="route('user.assessments.index')"
                    :active="request()->routeIs('user.assessments.*')">
                    {{ __('My Assessments') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('design-factors.index')"
                    :active="request()->routeIs('design-factors.*')">
                    {{ __('Design Factor') }}
                </x-responsive-nav-link>
            @endauth
        </div>
